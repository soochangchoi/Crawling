...
# 데이터프레임 생성 및 CSV 저장 (책 제목만)
df = pd.DataFrame(book_titles, columns=['제목'])
df.to_csv("yes24_os_database_bestseller_titles.csv", index=False, encoding='utf-8-sig')

print("\n크롤링 완료! 'yes24_os_database_bestseller_titles.csv' 파일로 저장되었습니다.")
